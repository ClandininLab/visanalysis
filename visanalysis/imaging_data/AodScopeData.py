...
class ImagingDataObject(imaging_data.ImagingData.ImagingDataObject):
    ...
    def getPoiData(self):
        """
        Assigns:
            -self.poi_data (dict): poi scan traces, photodiode traces, poi maps and overlays
            -self.metadata (dict): attributes from poi metadata file
        """
...
# %%        
    ...
    def __getAcquisitionTiming(self):
