...
class AnalysisGUI(QWidget):
    ...
    def initUI(self):
        ...
        self.grid.addWidget(self.driver_comboBox, 1, 0)
        ...
        self.grid.addWidget(self.indicator_comboBox, 2, 0)
        ...
        self.grid.addWidget(self.protocol_comboBox, 3, 0)
        ...
        # # Line edit for roi set name # #
        self.roi_set_name_box = QLineEdit()
        self.roi_set_name_box.setText('single_dendrite')
